...
function Portfolio() {
    return (
        <>
            <div className="container-fluid light_bg mb-0 padding_x">
                <div className="container">
                    <h3 className="text-center display-4 red-text">Portfolio</h3>
                    <div className="container-fluid" data-aos="zoom-in" data-aos-duration="2000" data-aos-once="false" data-aos-mirror="true">
