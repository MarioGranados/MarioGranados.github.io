  ...
  return (
    ...
    <div className="container col-xl-10 col-xxl-8 px-4 py-5">
        <div className="row align-items-center g-lg-5 py-5" >
          <div className="col-lg-7 text-center text-lg-start" data-aos='flip-up'>
            ...
            <p className="col-lg-10 fs-4 text-light">
              ...
              hiring manager. I am always looking for a challenge and to improve
              my coding skills. Help me out by shooting me an email by filling
              the following form.
            </p>
          </div>
